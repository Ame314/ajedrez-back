...
async def save_game(game: Game, request: Request):
    ...
    if game.vs_ai:
        # Solo buscar el jugador humano
        human_player = game.white_player if game.white_player != "Stockfish" else game.black_player
        human_user = await db.users.find_one({"username": human_player})
        ...
        # Partida entre humanos - actualizar ELO como antes
        ...
        # Actualizar usuarios con ELO y estadísticas
